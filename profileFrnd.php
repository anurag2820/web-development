	...
	<nav class="navbar navbar-inverse">
 		<div class="container">
 			...
 			<ul class="nav navbar-nav">
 				...
 				<li id="setActive" oncontextmenu="return false" ><a href="profile.php"><span class="glyphicon glyphicon-user"></span>  Profile</a></li>
 			...
 			<div class="col-xs-4">
 					<div class="row">
 						...
 						<div class="col-xs-6">
 							...
 							<button class="btn btn-success btn-sm" id="addAsFriend" onclick="addFriend(<?php echo $frndID; ?>);"><?php echo checkFriend($userID,$frndID);?></button>
 						</div>
 					</div>
 					<br>
 					<div class="row">
